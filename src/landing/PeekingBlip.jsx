...
// The "Blip — Active" design from the mascot mockup, ported as-is (same
// gradients, glowing lens, warm-tipped antenna, glinting panels) rather
// than the flatter placeholder this replaced — this is the version that
// got picked.
//
...
// to make the lens highlight glance toward `lookAt` and back. Driven by a
// CSS animation keyed on `look` (remounting replays it) rather than a JS
// timer, so there's no setState-on-a-timeout to coordinate.
