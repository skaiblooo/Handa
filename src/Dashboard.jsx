...
function AddDocumentTile({ isDark, onClick, tileRef, label, fullWidth }) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      onMouseDown={(e) => e.stopPropagation()}
      className={`glass-interactive glass-interactive-slow ${fullWidth ? 'glass-interactive-wide' : ''} flex items-center justify-center gap-3 rounded-2xl border-2 border-dashed ${
          ...
          visible.map((n, i) => {
            ...
            return (
              <div
                ...
                className={`glass-interactive glass-interactive-quick glass-interactive-wide cursor-pointer flex items-center gap-3 rounded-2xl p-3.5 border ${t(isDark, 'glass-dark border-white/10', 'glass-light border-slate-200')}`}
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onToggle}
        className={`glass-interactive glass-interactive-wide w-full flex items-center justify-between gap-3 p-5 text-left ${t(isDark, 'glass-dark', 'glass-light')}`}
      >
